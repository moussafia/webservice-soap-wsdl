 ...
 * 
 */
@WebServiceClient(name = "BanqueWs", targetNamespace = "http://ws.mohammedia.enset.ma/", wsdlLocation = "http://localhost:8080/BanqueWs?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.mohammedia.enset.ma/", "BanqueWs");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.mohammedia.enset.ma/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.mohammedia.enset.ma/", "BanqueServicePort"), BanqueService.class, features);
    }
